...
export default class PowerUpManager {
    ...
    activateDoubleLaser() {
        ...
        this.doubleLaserDuration =
            25000 + durationBonus;

        this.doubleLaserEndTime =
            this.scene.time.now +
            this.doubleLaserDuration;
    ...
    updateShieldVisual() {
        ...
        this.shieldVisual.arc1.angle +=
            2.4;

        this.shieldVisual.arc2.angle -=
            2.1;

        this.shieldVisual.arc3.angle +=
            3.1;
